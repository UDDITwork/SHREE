      ...
      <main className="relative z-10">
        ...
        <section className="min-h-screen bg-black relative overflow-hidden py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-8">
            ...
            <motion.h1
              className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-[0.9] text-center"
            ...
            <div className="relative flex flex-col items-center justify-center mt-8">
              ...
              {/* CTA Link - Centered below */}
              <motion.a
                href="mailto:udditalerts247@gmail.com"
                className="inline-flex items-center gap-2 mt-8 text-white hover:text-[#00ff88] transition group"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ delay: 0.8 }}
