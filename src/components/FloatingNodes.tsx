...
export const HeroContent = () => {
  return (
    <motion.div
      className="absolute inset-0 flex flex-col items-center justify-end z-10 px-6 pb-0"
    ...
    >
      ...
      >
        <div className="w-12 h-12 rounded-full border border-white/30 flex items-center justify-center cursor-pointer hover:bg-white/10 transition">
      ...
      {/* Subtitle */}
      <motion.p
        className="text-lg md:text-xl text-gray-400 text-center max-w-2xl mb-10"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 0.9 }}
      >
        Specializing in RAG Systems, MCP Servers, and Patent AI Tools.
        Building production platforms serving 500+ clients.
      </motion.p>
      ...
      >
        ...
        <a
          href="#projects"
          className="inline-flex items-center gap-2 px-6 py-3 bg-transparent border border-white/20 text-white rounded-full font-medium hover:bg-white/5 transition"
        >
          View Projects
        </a>
      </motion.div>
...
export const ScrollIndicator = () => {
  return (
    <motion.div
      className="absolute bottom-8 left-8 flex items-center gap-3 z-20"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
